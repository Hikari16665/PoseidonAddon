...
public class SafeAreaMachineTier1 extends ASafeAreaMachine {
    public SafeAreaMachineTier1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
